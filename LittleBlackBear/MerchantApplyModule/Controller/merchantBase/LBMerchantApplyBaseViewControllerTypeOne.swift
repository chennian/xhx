		...
		didSet{
			...
			case .otherApply:
				cellItems = [[.common(.describe1(imgName:"myIfonMark",title: "我的信息", subtitle: "")),
							 ...
							 [  .image(.images(images: [UIImage( named: "idCardPostive"), UIImage( named: "idCardNegative"),UIImage( named: "holdIdCard")])),
								.button(.button(title: "下一步", top: 30, bottom: 25))
							]]
			}
		}
...
//            })
    ...
    override func buttonCell(_ buttonCell: ButtonTableViewCell, nextButtonClick nextButton: UIButton) {
		...
		case .otherApply:
			...
			guard (cellContentDict[IndexPath(row: 0, section: 2)] as? [UIImage])?.count == 3 else {
