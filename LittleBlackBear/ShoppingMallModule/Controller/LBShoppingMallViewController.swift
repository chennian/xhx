...
//        return cell
        ...
        case .groupCoupons(let model):
            let cell : LBSecondCouponTableViewCell = tableView.dequeueReusableCell(forIndexPath: indexPath)//dequeueReusableCell(withTableView: tableView, cellClass: LBSecondCouponTableViewCell.self)
