...
private let reuseIdentify = "photoCollectionViewCell"
...
//    let reuseIdentifier = "photoCollectionViewCell"
	override func viewDidLoad() {
		...
		self.collectionView!.register(UINib.init(nibName: reuseIdentify, bundle: nil), forCellWithReuseIdentifier: reuseIdentify)
	...
	private func configBottomToolBar() {
        ...
        let positionX = UIScreen.main.bounds.height - self.toolbarHeight - LL_StatusBarAndNavigationBarHeight
...
//        UIApplication.shared.setStatusBarHidden(false, with: .none)
	...
	override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentify, for: indexPath) as! photoCollectionViewCell
