...
class ZJSinglePhotoPreviewVC: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate,PhotoPreviewCellDelegate {
...
//        }
        cell.imgRUL = self.selectImages?[indexPath.row]
        return cell
    }
