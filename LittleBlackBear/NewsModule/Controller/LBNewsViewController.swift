...
class LBNewsViewController: UITableViewController {
...
extension LBNewsViewController:LBNewsHttpServer{
...
//MARK: 实现浏览器代理协议
extension LBNewsViewController: PhotoBrowserDelegate {
...
// MARK: 分享
extension LBNewsViewController:BXShareViewDelegate{
...
// 登录协议
extension LBNewsViewController:LBPresentLoginViewControllerProtocol{
}
